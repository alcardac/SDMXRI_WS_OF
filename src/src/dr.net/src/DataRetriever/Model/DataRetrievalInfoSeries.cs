...
namespace Estat.Nsi.DataRetriever.Model
{
    ...
    internal class DataRetrievalInfoSeries : DataRetrievalInfo
    {
        ...
        public bool WriteGroups
        {
            get
            {
                return this.BaseDataQuery.DataQueryDetail == DataQueryDetailEnumType.Full || this.BaseDataQuery.DataQueryDetail == DataQueryDetailEnumType.NoData;
            }
        }
        ...
        public bool WriteObservations
        {
            get
            {
                return this.BaseDataQuery.DataQueryDetail == DataQueryDetailEnumType.Full || this.BaseDataQuery.DataQueryDetail == DataQueryDetailEnumType.DataOnly;
            }
        }

        /// <summary>
        /// Gets a value indicating whether write attributes. It depends on the <see cref="IBaseDataQuery.DataQueryDetail"/>
        /// </summary>
        /// <value>
        ...
        private void AddTimeSeriesGroups(IComponentMapping componentMapping)
        {
            foreach (var groupEntity in componentMapping.Component.AttAssignmentGroups)
            {
                ...
                if (!this._groups.TryGetValue(groupEntity, out information))
                {
