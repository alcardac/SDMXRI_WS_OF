// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StructureRetrieverAvailableData.cs" company="Eurostat">
...
namespace Estat.Nsi.StructureRetriever.Manager
{
    ...
    /// </remarks>
    public class StructureRetrieverAvailableData : IMutableStructureSearchManager
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StructureRetrieverAvailableData"/> class.
        /// </summary>
        ...
        /// </exception>
        public StructureRetrieverAvailableData(ConnectionStringSettings connectionStringSettings, SdmxSchema sdmxSchema)
        {
        ...
        {
            return this._authStructureRetriever.RetrieveStructures(queries, resolveReferences, returnStub, null);
        }
