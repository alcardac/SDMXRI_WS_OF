// -----------------------------------------------------------------------
// <copyright file="KeyDescriptorValuesRepresentationType.cs" company="Eurostat">
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Structure
{
    ...
    /// </summary>
    public partial class KeyDescriptorValuesRepresentationType
    {
        /// <summary>
        ...
        {
            return this.TextFormat = new KeyDescriptorValuesTextFormatType();
        }
    }
}