// -----------------------------------------------------------------------
// <copyright file="DataSetRepresentationType.cs" company="Eurostat">
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Structure
{
    ...
    /// </summary>
    public partial class DataSetRepresentationType
    {
        /// <summary>
        ...
        {
            return this.TextFormat = new DataSetTextFormatType();
        }
    }
}