// -----------------------------------------------------------------------
// <copyright file="ReportingYearStartDayRepresentationType.cs" company="Eurostat">
...
{
    public partial class ReportingYearStartDayRepresentationType
    {
        /// <summary>
        ...
        {
            return this.TextFormat = new ReportingYearStartDayTextFormatType();
        }
    }
}