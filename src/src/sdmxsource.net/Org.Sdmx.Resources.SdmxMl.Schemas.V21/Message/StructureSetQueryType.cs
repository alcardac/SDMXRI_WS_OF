// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StructureSetQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The structure set query type.
    /// </summary>
    public partial class StructureSetQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.StructureSetQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="StructureSetQueryType"/> class.
        /// </summary>
        static StructureSetQueryType()
        {
        ...
        public Query.StructureSetQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.StructureSetQueryType)x;
            }
