// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ConstraintQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The constraint query type.
    /// </summary>
    public partial class ConstraintQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.ConstraintQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="ConstraintQueryType"/> class.
        /// </summary>
        static ConstraintQueryType()
        {
        ...
        public Query.ConstraintQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.ConstraintQueryType)x;
            }
