// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DataQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
//   The data query type.
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// </para>
    /// </summary>
    public partial class GenericDataQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.GenericDataQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="GenericDataQueryType"/> class.
        /// </summary>
        static GenericDataQueryType()
        {
        ...
        /// <summary>
        /// Gets or sets the TODO structures.
        /// </summary>
        public Query.GenericDataQueryType DataQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.GenericDataQueryType)x;
            }
