// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StructuresQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The structures query type.
    /// </summary>
    public partial class StructuresQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.StructuresQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="StructuresQueryType"/> class.
        /// </summary>
        static StructuresQueryType()
        {
        ...
        public Query.StructuresQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.StructuresQueryType)x;
            }
