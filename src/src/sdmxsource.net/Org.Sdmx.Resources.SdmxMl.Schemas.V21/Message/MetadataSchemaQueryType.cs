// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MetadataSchemaQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The metadata schema query type.
    /// </summary>
    public partial class MetadataSchemaQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.MetadataSchemaQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="MetadataSchemaQueryType"/> class.
        /// </summary>
        static MetadataSchemaQueryType()
        {
        ...
        public Query.MetadataSchemaQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.MetadataSchemaQueryType)x;
            }
