// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CodelistQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The codelist query type.
    /// </summary>
    public partial class CodelistQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.CodelistQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="CodelistQueryType"/> class.
        /// </summary>
        static CodelistQueryType()
        {
        ...
        public Query.CodelistQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.CodelistQueryType)x;
            }
