// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MetadataStructureQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The metadata structure query type.
    /// </summary>
    public partial class MetadataStructureQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.MetadataStructureQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="MetadataStructureQueryType"/> class.
        /// </summary>
        static MetadataStructureQueryType()
        {
        ...
        public Query.MetadataStructureQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.MetadataStructureQueryType)x;
            }
