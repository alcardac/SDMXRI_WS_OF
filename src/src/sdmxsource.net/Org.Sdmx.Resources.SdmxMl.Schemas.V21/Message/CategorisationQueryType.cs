// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CategorisationQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The categorisation query type.
    /// </summary>
    public partial class CategorisationQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.CategorisationQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="CategorisationQueryType"/> class.
        /// </summary>
        static CategorisationQueryType()
        {
        ...
        public Query.CategorisationQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.CategorisationQueryType)x;
            }
