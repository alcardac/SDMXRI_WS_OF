// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ConceptSchemeQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The concept scheme query type.
    /// </summary>
    public partial class ConceptSchemeQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.ConceptSchemeQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="ConceptSchemeQueryType"/> class.
        /// </summary>
        static ConceptSchemeQueryType()
        {
        ...
        public Query.ConceptSchemeQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.ConceptSchemeQueryType)x;
            }
