// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrganisationSchemeQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The organisation scheme query type.
    /// </summary>
    public partial class OrganisationSchemeQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.OrganisationSchemeQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="OrganisationSchemeQueryType"/> class.
        /// </summary>
        static OrganisationSchemeQueryType()
        {
        ...
        public Query.OrganisationSchemeQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.OrganisationSchemeQueryType)x;
            }
