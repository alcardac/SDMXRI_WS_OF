// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DataflowQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The dataflow query type.
    /// </summary>
    public partial class DataflowQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.DataflowQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="DataflowQueryType"/> class.
        /// </summary>
        static DataflowQueryType()
        {
        ...
        public Query.DataflowQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.DataflowQueryType)x;
            }
