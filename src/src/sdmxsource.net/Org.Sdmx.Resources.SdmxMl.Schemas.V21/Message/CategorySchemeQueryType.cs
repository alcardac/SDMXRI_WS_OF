// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CategorySchemeQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The category scheme query type.
    /// </summary>
    public partial class CategorySchemeQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.CategorySchemeQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="CategorySchemeQueryType"/> class.
        /// </summary>
        static CategorySchemeQueryType()
        {
        ...
        public Query.CategorySchemeQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.CategorySchemeQueryType)x;
            }
