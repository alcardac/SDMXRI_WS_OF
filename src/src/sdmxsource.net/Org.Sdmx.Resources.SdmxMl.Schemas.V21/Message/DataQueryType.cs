...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The data query type.
    /// </summary>
    public partial class DataQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.DataQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="DataQueryType"/> class.
        /// </summary>
        static DataQueryType()
        {
        ...
        public Query.DataQueryType BaseDataQueryType
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.DataQueryType)x;
            }
