// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MetadataQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The metadata query type.
    /// </summary>
    public partial class MetadataQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.MetadataQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="MetadataQueryType"/> class.
        /// </summary>
        static MetadataQueryType()
        {
        ...
        public Query.MetadataQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.MetadataQueryType)x;
            }
