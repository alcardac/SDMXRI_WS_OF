// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DataSchemaQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The data schema query type.
    /// </summary>
    public partial class DataSchemaQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.DataSchemaQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="DataSchemaQueryType"/> class.
        /// </summary>
        static DataSchemaQueryType()
        {
        ...
        public Query.DataSchemaQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.DataSchemaQueryType)x;
            }
