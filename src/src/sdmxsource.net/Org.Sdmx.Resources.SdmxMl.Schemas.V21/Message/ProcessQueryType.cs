// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ProcessQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The process query type.
    /// </summary>
    public partial class ProcessQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.ProcessQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="ProcessQueryType"/> class.
        /// </summary>
        static ProcessQueryType()
        {
        ...
        public Query.ProcessQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.ProcessQueryType)x;
            }
