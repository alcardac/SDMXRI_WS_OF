// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReportingTaxonomyQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The reporting taxonomy query type.
    /// </summary>
    public partial class ReportingTaxonomyQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.ReportingTaxonomyQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="ReportingTaxonomyQueryType"/> class.
        /// </summary>
        static ReportingTaxonomyQueryType()
        {
        ...
        public Query.ReportingTaxonomyQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.ReportingTaxonomyQueryType)x;
            }
