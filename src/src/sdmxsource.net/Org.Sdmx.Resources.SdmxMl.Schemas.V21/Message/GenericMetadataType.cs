// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GenericMetadataType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The generic metadata type.
    /// </summary>
    public partial class GenericMetadataType
    {
        ...
        /// The header type.
        /// </summary>
        private static readonly Type _headerType = typeof(GenericMetadataHeaderType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="GenericMetadataType"/> class.
        /// </summary>
        ...
        /// </summary>
        public new GenericMetadataHeaderType Header
        {
            get
            {
                XElement x = this.GetElement(_headerXName);
                return (GenericMetadataHeaderType)x;
            }
