// --------------------------------------------------------------------------------------------------------------------
// <copyright file="HierarchicalCodelistQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The hierarchical codelist query type.
    /// </summary>
    public partial class HierarchicalCodelistQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.HierarchicalCodelistQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="HierarchicalCodelistQueryType"/> class.
        /// </summary>
        static HierarchicalCodelistQueryType()
        {
        ...
        public Query.HierarchicalCodelistQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.HierarchicalCodelistQueryType)x;
            }
