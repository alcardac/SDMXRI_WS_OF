// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DataStructureQueryType.cs" company="EUROSTAT">
//   EUPL
// </copyright>
// <summary>
...
namespace Org.Sdmx.Resources.SdmxMl.Schemas.V21.Message
{
    ...
    /// The data structure query type.
    /// </summary>
    public partial class DataStructureQueryType
    {
        ...
        /// The contents type.
        /// </summary>
        private static readonly Type _contentsType = typeof(Query.DataStructureQueryType);
        ...
        /// <summary>
        /// Initializes static members of the <see cref="DataStructureQueryType"/> class.
        /// </summary>
        static DataStructureQueryType()
        {
        ...
        public Query.DataStructureQueryType SdmxQuery
        {
            get
            {
                XElement x = this.GetElement(_contentsXName);
                return (Query.DataStructureQueryType)x;
            }
