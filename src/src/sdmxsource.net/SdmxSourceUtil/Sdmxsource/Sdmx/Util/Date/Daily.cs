// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Daily.cs" company="Eurostat">
...
namespace Org.Sdmxsource.Sdmx.Util.Date
{
    ...
    /// Daily frequency
    /// </summary>
    public class Daily : BasePeriodicity, IPeriodicity
    {
        #region Constants
        ...
        /// </summary>
        public const string SdmxDateTimeFormat = "yyyy-MM-dd";
        ...
        /// The number of months in a period
        /// </summary>
        private const short NumberOfPeriods = 365;
