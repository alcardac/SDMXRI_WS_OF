...
namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.MutableBaseObjects.Datastructure {
	...
	[Serializable]
	public class PrimaryMeasureMutableObjectBaseCore : 
			ComponentMutableObjectBaseCore, IPrimaryMeasureMutableObjectBase {
		private const long serialVersionUID = 1L;
	
		public PrimaryMeasureMutableObjectBaseCore(
				IPrimaryMeasureObjectBase IprimaryMeasure) : base(IprimaryMeasure) {
		}
