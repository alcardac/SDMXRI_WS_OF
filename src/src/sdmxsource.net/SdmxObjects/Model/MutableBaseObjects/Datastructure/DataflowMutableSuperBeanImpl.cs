...
// --------------------------------------------------------------------------------------------------
 namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.MutableBaseObjects.Datastructure {
	...
	[Serializable]
	public class DataflowMutableObjectBaseCore : 
			MaintainableMutableObjectBaseCore, IDataflowMutableObjectBase {
	
		private const long serialVersionUID = 1L;
	
		private IDataStructureMutableObjectBase _keyFamily;
		...
		public DataflowMutableObjectBaseCore() {
	
		}
	
		
		public virtual IDataStructureMutableObjectBase DataStructure {
		  get {
				return _keyFamily;
			}
		  set {
				this._keyFamily = value;
			}
		}
