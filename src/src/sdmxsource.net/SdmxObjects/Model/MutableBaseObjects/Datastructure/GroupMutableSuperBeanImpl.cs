...
namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.MutableBaseObjects.Datastructure {
	...
	[Serializable]
	public class GroupMutableObjectBaseCore : IdentifiableMutableObjectBaseCore
		, IGroupMutableObjectBase {
		private const long serialVersionUID = 5282160962223299927L;
	
		//	private string attachmentConstraintRef;
		//	private List<TextTypeWrapper> description;
		//	private List<IDimensionObjectBase> dimension = new ArrayList<IDimensionObjectBase>();
		//	private string id;
		//TODO implement
		public GroupMutableObjectBaseCore(IGroupObjectBase group) : base(group) {
		}
	
		public GroupMutableObjectBaseCore() {
