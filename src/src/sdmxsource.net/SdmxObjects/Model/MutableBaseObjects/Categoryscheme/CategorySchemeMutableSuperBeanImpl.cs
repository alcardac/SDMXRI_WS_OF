...
// --------------------------------------------------------------------------------------------------
 namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.MutableBaseObjects.Categoryscheme {
	...
	[Serializable]
	public class CategorySchemeMutableObjectBaseCore : 
			MaintainableMutableObjectBaseCore, 
			ICategorySchemeMutableObjectBase {
		private const long serialVersionUID = 1L;
	
		private IList<ICategoryMutableObjectBase> categories;
		...
		public virtual IList<ICategoryMutableObjectBase> Categories {
		  get {
				return categories;
			}
		  set {
