...
namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.MutableBaseObjects.Base {
	...
	[Serializable]
	public abstract class ItemMutableObjectBaseCore<T> : NameableMutableObjectBaseCore  where T : IMaintainableMutableObjectBase {
		private const long serialVersionUID = 1L;
	
		private T _itemScheme;
	
		public ItemMutableObjectBaseCore(T itemScheme, IItemObjectBase<T> item) : base(item) {
			this._itemScheme = itemScheme;
		}
	
		public ItemMutableObjectBaseCore() {
