...
namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.BaseObjects.Codelist {
	...
	[Serializable]
	public class HierarchicalCodelistObjectBaseCore : 
			MaintainableObjectBaseCore, IHierarchicalCodelistObjectBase {
		private const long serialVersionUID = 8192545947210661996L;
	
		private ISet<IHierarchyObjectBase<IHierarchicalCodelistObjectBase>> hierarchies;
		...
		public virtual ISet<IHierarchyObjectBase<IHierarchicalCodelistObjectBase>> Hierarchies {
		  get {
				return new HashSet<IHierarchyObjectBase<IHierarchicalCodelistObjectBase>>(
						hierarchies);
			}
		}
