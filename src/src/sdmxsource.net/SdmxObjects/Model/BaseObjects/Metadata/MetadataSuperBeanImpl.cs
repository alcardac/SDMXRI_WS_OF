...
namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.BaseObjects.Metadata {
	...
	[Serializable]
	public class MetadataObjectBaseCore : ObjectBaseCore, IMetadataBase {
		private const long serialVersionUID = 6910821802418090357L;
		private IList<IMetadataSetBase> metadataSet;
		private IMetadata builtFrom;
		...
		public virtual IList<IMetadataSetBase> MetadataSet {
		  get {
              return new List<IMetadataSetBase>(metadataSet);
			}
		}
