...
namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.BaseObjects.Metadata {
	...
	[Serializable]
	public class MetadataReportBaseCore : ObjectBaseCore, IMetadataReportBase {
		private const long serialVersionUID = 212629478840566281L;
		private ITargetBase target;
		private IList<IReportedAttributeBase> reportedAttributes;
		private IMetadataReport builtFrom;
        ...
        public virtual ITargetBase Target
        {
		  get {
				return target;
			}
		...
		public IMetadataReport BuiltFrom {
		  get {
				return builtFrom;
			}
		}
