...
namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.BaseObjects.Base {
	...
	[Serializable]
	public abstract class ItemObjectBaseCore<T>
		 : NameableObjectBaseCore, IItemObjectBase<T>  where T : IMaintainableObjectBase {
		private const long serialVersionUID = 1L;
	
		private T itemScheme;
	
		public ItemObjectBaseCore(IItemObject identifiable, T itemScheme0) : base(identifiable) {
			this.itemScheme = itemScheme0;
		}
	
		
		public virtual T ItemScheme {
		  get {
				return itemScheme;
			}
		}
