...
namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.BaseObjects.Base {
	...
	[Serializable]
	public class AttributeObjectBaseCore : ComponentObjectBaseCore, IAttributeObjectBase {
		...
		public virtual String AssignmentStatus {
		  get {
				return _attribute.AssignmentStatus;
			}
		}
		...
		public virtual AttributeAttachmentLevel AttachmentLevel {
		  get {
				return _attribute.AttachmentLevel;
			}
		}
		
	
		
		public virtual IList<String> DimensionReference {
		  get {
				return _attribute.DimensionReference;
			}
		}
		...
		public virtual String AttachmentGroup {
		  get {
				return _attribute.AttachmentGroup;
			}
		}
		...
		public virtual String PrimaryMeasureReference {
		  get {
				return _attribute.PrimaryMeasureReference;
			}
		}
		...
		public virtual bool Mandatory {
		  get {
				return _attribute.Mandatory;
			}
		}
		
	
		
		public IAttribute BuiltFrom {
		  get {
				return _attribute;
			}
		}
