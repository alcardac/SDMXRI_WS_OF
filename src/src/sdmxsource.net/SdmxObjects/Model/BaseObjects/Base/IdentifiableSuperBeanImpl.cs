...
// --------------------------------------------------------------------------------------------------
 namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.BaseObjects.Base {
	...
	[Serializable]
	public abstract class IdentifiableObjectBaseCore : AnnotableObjectBaseCore
		, IIdentifiableObjectBase {
		private const long serialVersionUID = 1L;
	
		private String id;
		private String urn;
	
		public IdentifiableObjectBaseCore(IIdentifiableObject identifiable) : base(identifiable) {
			id = identifiable.Id;
			urn = identifiable.Urn;
		}
		...
		public override bool Equals(Object obj) {
			if (obj  is  IIdentifiableObjectBase) {
				IIdentifiableObjectBase that = (IIdentifiableObjectBase) obj;
