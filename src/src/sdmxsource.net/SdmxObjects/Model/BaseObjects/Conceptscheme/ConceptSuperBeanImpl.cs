...
namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.BaseObjects.Conceptscheme {
	...
	[Serializable]
	public class ConceptObjectBaseCore : NameableObjectBaseCore, 
			IConceptObjectBase {
		private const long serialVersionUID = 1L;
		private readonly ICodelistObjectBase _representation;
		private readonly ITextFormat _textFormat;
		private readonly IConceptObject _builtFrom;
		...
		public virtual ICodelistObjectBase CoreRepresentation {
		  get {
		...
		public virtual bool HasRepresentation() {
			return _representation != null;
		}
		...
		public IConceptObject BuiltFrom {
		  get {
				return _builtFrom;
			}
		}
