...
// --------------------------------------------------------------------------------------------------
 namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.BaseObjects.Datastructure {
	...
	[Serializable]
	public class DataflowObjectBaseCore : MaintainableObjectBaseCore, IDataflowObjectBase {
		private const long serialVersionUID = 1L;
	
		private readonly IDataStructureObjectBase _keyFamily;
		...
		public virtual IDataStructureObjectBase DataStructure {
		  get {
		...
		public override IDataflowObject BuiltFrom {
		  get {
				return _dataflow;
			}
		}
