...
namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.BaseObjects.Process {
	...
	[Serializable]
	public class ProcessObjectBaseCore : MaintainableObjectBaseCore, 
			IProcessObjectBase {
	
		private const long serialVersionUID = -8679939983498220784L;
	
		private readonly IProcessObject _process;
		...
		public virtual IProcessObject Process {
		  get {
