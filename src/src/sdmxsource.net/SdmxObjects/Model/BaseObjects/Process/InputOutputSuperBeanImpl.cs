...
namespace Org.Sdmxsource.Sdmx.SdmxObjects.Model.BaseObjects.Process {
	...
	[Serializable]
	public class InputOutputObjectBaseCore : AnnotableObjectBaseCore, IInputOutputObjectBase {
	
		private const long serialVersionUID = -7130852167819727964L;
	
		private readonly IInputOutputObject _inputOutputObj;
		private readonly string _localId;
		private readonly IIdentifiableObject _structure;
        ...
        public virtual IInputOutputObject InputOutputObj
        {
		  get {
				return this._inputOutputObj;
			}
		}
