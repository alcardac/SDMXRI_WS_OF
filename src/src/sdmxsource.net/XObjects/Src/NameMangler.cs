...
namespace Xml.Schema.Linq.CodeGen
{
    internal static class NameGenerator 
    {
        ...
        static NameGenerator()
        {
            ...
            string [] keywordlist = { "abstract","event","new", "struct","as","explicit","null","switch",
    ...
    internal class SymbolEntry
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if(se != null)
            {
                return (xsdNamespace == se.xsdNamespace) && identifierName.Equals(se.identifierName, StringComparison.OrdinalIgnoreCase);
            }
            return false;
        }
