    ...
    internal abstract class TypeBuilder {  
        ...
        internal void CreateServicesMembers() {
            ...
            if (clrTypeInfo.typeOrigin == SchemaOrigin.Element) { //Disable load and parse for complex types
                ...
                //// TODO add xml reader input
                ////var xmlloadReader = CodeDomHelper.CreateStaticMethod(
                ////   "Load", clrTypeName, innerType, "xmlFile", "System.Xml.XmlReader", useAutoTyping);
                ...
                ////decl.Members.Add(xmlloadReader);
