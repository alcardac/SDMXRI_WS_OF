...
namespace Xml.Schema.Linq.CodeGen
{
    ...
    {
        internal static CodeExpression CreateSimpleTypeDef(
            ClrSimpleTypeInfo typeInfo, 
            Dictionary<XmlSchemaObject, string> nameMappings,
            LinqToXsdSettings settings, 
            bool memberOrItemType)
        {
            ...
            if (memberOrItemType && typeInfo.IsGlobal)  
            {
                ...
                return CodeDomHelper.CreateFieldReference(
                    typeInfo.clrtypeName, Constants.SimpleTypeDefInnerType);
            }
            else 
            {
                return MaterializeSimpleTypeDef(
                    typeInfo, nameMappings, settings);
            }
        }
        ...
        internal static CodeExpression CreateGetBuiltInSimpleType(XmlTypeCode typeCode)  
        {
            return CodeDomHelper.CreateMethodCall(
                ...
                CodeDomHelper.CreateFieldReference(
                    Constants.XmlTypeCode, typeCode.ToString()));
        }
        ...
        private static CodeExpression CreateTypedValueExpression(
            XmlSchemaDatatype dataType, object value) 
        {
            ...
            switch(typeCode) {
                ...
                case  XmlTypeCode.AnyUri:
                    ...
                    return new CodeObjectCreateExpression(
                        typeof(Uri), new CodePrimitiveExpression(((Uri)value).OriginalString));
                ...
                case XmlTypeCode.Duration:
                    ...
                    return new CodeObjectCreateExpression(
                        typeof(TimeSpan), new CodePrimitiveExpression(ts.Ticks));
                ...
                case XmlTypeCode.DateTime:
                    ...
                    return new CodeObjectCreateExpression(
                        typeof(DateTime), new CodePrimitiveExpression(dt.Ticks));
        ...
        private static CodeExpression CreateTypeConversionExpr(
        ...
        internal static CodeExpression CreateValueExpression(
            string builtInType, string strValue)
        {                       
            ...
            {
                return new CodeObjectCreateExpression(
                    "Uri", new CodePrimitiveExpression(strValue) );
            }
            else
            {
        ...
        internal static CodeArrayCreateExpression CreateFixedDefaultArrayValueInit(
        ...
        internal static CodeExpression CreateFixedDefaultValueExpression(
            CodeTypeReference type, string value)
        {
