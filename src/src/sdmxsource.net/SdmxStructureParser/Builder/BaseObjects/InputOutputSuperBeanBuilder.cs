...
namespace Org.Sdmxsource.Sdmx.Structureparser.Builder.BaseObjects.Impl {
	...
	using Org.Sdmxsource.Sdmx.SdmxStructureRetrieval.Engine;
	...
	public class InputOutputSuperBeanBuilder {
		...
		public IINputOutputObjectBase Build(IInputOutput buildFrom,
				ISdmxRetrievalManager retrievalManager) {
			ICrossReferenceResolverEngine resolver = new CrossReferenceResolverEngineCore();
			IIdentifiableObject ibean = resolver.ResolveCrossReference(
					buildFrom.StructureReference, retrievalManager);
			return new InputOutputObjectBaseCore(buildFrom, ibean);
		}
	}
}
