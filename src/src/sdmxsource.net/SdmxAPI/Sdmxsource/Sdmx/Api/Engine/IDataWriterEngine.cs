...
namespace Org.Sdmxsource.Sdmx.Api.Engine
{
    ...
    /// </example>
    public interface IDataWriterEngine : IWriterEngine
    {
        ...
        /// if the dsd is null
        /// </exception>
        void StartDataset(IDataflowObject dataflow, IDataStructureObject dsd, IDatasetHeader header, params IAnnotation[] annotations);
