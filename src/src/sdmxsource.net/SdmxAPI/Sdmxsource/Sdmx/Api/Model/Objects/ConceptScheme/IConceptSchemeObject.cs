// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IConceptSchemeObject.cs" company="Eurostat">
...
namespace Org.Sdmxsource.Sdmx.Api.Model.Objects.ConceptScheme
{
    ...
    /// </summary>
    public interface IConceptSchemeObject : IItemSchemeObject<IConceptObject>
    {
        #region Public Properties

        /// <summary>
        ///     Gets a value indicating whether the is the default concept scheme
        /// </summary>
        /// <value> </value>
        ...
        /// </summary>
        /// <value> </value>
        new IConceptSchemeMutableObject MutableInstance { get; }
        ...
        /// </param>
        new IConceptSchemeObject GetStub(Uri actualLocation, bool isServiceUrl);

        /// <summary>
        /// Gets the item by unique identifier.
        /// </summary>
        /// <param name="id">The unique identifier.</param>
        /// <returns>Returns the concept by id, or null if there is no concept with the given id</returns>
        IConceptObject GetItemById(string id);
