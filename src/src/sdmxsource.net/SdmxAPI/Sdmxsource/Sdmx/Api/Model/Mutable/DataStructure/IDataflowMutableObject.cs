// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IDataflowMutableObject.cs" company="Eurostat">
...
namespace Org.Sdmxsource.Sdmx.Api.Model.Mutable.DataStructure
{
    ...
    /// <summary>
    ///     The DataflowMutableObject interface.
    /// </summary>
    public interface IDataflowMutableObject : IMaintainableMutableObject
    {
        ...
        /// </summary>
        IStructureReference DataStructureRef { get; set; }
        ...
        /// </summary>
        /// <value> </value>
        new IDataflowObject ImmutableInstance { get; }
