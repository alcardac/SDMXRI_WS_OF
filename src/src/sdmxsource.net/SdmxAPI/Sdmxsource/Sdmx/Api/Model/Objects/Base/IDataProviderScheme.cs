// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IDataProviderScheme.cs" company="Eurostat">
...
namespace Org.Sdmxsource.Sdmx.Api.Model.Objects.Base
{
    ...
    /// </summary>
    public interface IDataProviderScheme : IOrganisationScheme<IDataProvider>
    {
        ...
        /// </summary>
        /// <value> </value>
        new IDataProviderSchemeMutableObject MutableInstance { get; }
