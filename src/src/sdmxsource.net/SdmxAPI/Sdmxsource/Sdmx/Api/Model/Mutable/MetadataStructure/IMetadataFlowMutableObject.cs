// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IMetadataFlowMutableObject.cs" company="Eurostat">
...
namespace Org.Sdmxsource.Sdmx.Api.Model.Mutable.MetadataStructure
{
    ...
    /// <summary>
    ///     The MetadataFlowMutableObject interface.
    /// </summary>
    public interface IMetadataFlowMutableObject : IMaintainableMutableObject
    {
        ...
        /// </summary>
        /// <value> </value>
        new IMetadataFlow ImmutableInstance { get; }

        /// <summary>
        ///     Gets or sets the metadata structure ref.
        /// </summary>
        IStructureReference MetadataStructureRef { get; set; }
