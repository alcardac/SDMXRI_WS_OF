...
namespace Estat.Sri.MappingStoreRetrieval.Manager
{
    ...
    public abstract class RetrievalManagerBase : ISdmxMutableObjectRetrievalManager
    {
        ...
        /// </returns>
        public abstract ICategorisationMutableObject GetMutableCategorisation(IMaintainableRefObject xref, bool returnLatest, bool returnStub);
        ...
        /// list of sdmxObjects that match the search criteria
        /// </returns>
        public abstract ISet<ICategorisationMutableObject> GetMutableCategorisationObjects(IMaintainableRefObject xref, bool returnLatest, bool returnStub);
        ...
        /// </returns>
        public abstract IDataflowMutableObject GetMutableDataflow(IMaintainableRefObject xref, bool returnLatest, bool returnStub);
        ...
        /// list of sdmxObjects that match the search criteria
        /// </returns>
        public abstract ISet<IDataflowMutableObject> GetMutableDataflowObjects(IMaintainableRefObject xref, bool returnLatest, bool returnStub);
        ...
        public IMaintainableMutableObject GetMutableMaintainable(IStructureReference query, bool returnLatest, bool returnStub)
        {
            ...
            switch (query.MaintainableStructureEnumType.EnumType)
            {
                ...
                case SdmxStructureEnumType.Categorisation:
                    return this.GetMutableCategorisation(xref, returnLatest, returnStub);
                ...
                case SdmxStructureEnumType.Dataflow:
                    return this.GetMutableDataflow(xref, returnLatest, returnStub);
        ...
        /// </returns>
        public ISet<IMaintainableMutableObject> GetMutableMaintainables(IStructureReference query, bool returnLatest, bool returnStub)
        {
            IMaintainableRefObject xref = query.MaintainableReference;
            switch (query.MaintainableStructureEnumType.EnumType)
            {
                ...
                case SdmxStructureEnumType.Categorisation:
                    return new HashSet<IMaintainableMutableObject>(this.GetMutableCategorisationObjects(xref, returnLatest, returnStub));
                case SdmxStructureEnumType.CategoryScheme:
                ...
                case SdmxStructureEnumType.Dataflow:
                    return new HashSet<IMaintainableMutableObject>(this.GetMutableDataflowObjects(xref, returnLatest, returnStub));
                case SdmxStructureEnumType.HierarchicalCodelist:
