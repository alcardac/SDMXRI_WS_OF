// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IMutableRetrievalManagerFactory.cs" company="Eurostat">
...
namespace Estat.Sri.MappingStoreRetrieval.Factory
{
    ...
    /// The MutableRetrievalManagerFactory interface.
    /// </summary>
    public interface IMutableRetrievalManagerFactory
    {
        ...
        /// </returns>
        ISdmxMutableObjectRetrievalManager GetRetrievalManager<T>(T settings);
