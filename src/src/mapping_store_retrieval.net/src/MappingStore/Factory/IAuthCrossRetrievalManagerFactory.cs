...
namespace Estat.Sri.MappingStoreRetrieval.Factory
{
    ...
    /// </summary>
    public interface IAuthCrossRetrievalManagerFactory
    {
        ...
        /// </returns>
        IAuthCrossReferenceMutableRetrievalManager GetCrossRetrievalManager<T>(T settings, IAuthSdmxMutableObjectRetrievalManager retrievalManager);
        ...
        /// The <see cref="ICrossReferenceMutableRetrievalManager"/>.
        /// </returns>
        IAuthCrossReferenceMutableRetrievalManager GetCrossRetrievalManager<T>(T settings, IAuthAdvancedSdmxMutableObjectRetrievalManager retrievalManager);
