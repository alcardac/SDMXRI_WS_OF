namespace IstatExtension.Controllers.Engine
{
    using System;
    ...
    /// </summary>
    public class SdmxJsonDelayedDataWriterEngine : IDataWriterEngine
    {
        /// <summary>
        /// The _actions
        /// </summary>
        ...
        private readonly SdmxJsonBaseDataWriter _dataWriterEngine;
        ...
        public SdmxJsonDelayedDataWriterEngine(IDataWriterEngine dataWriterEngine, Queue<Action> actions)
        {
            ...
            this._dataWriterEngine = (SdmxJsonBaseDataWriter)dataWriterEngine;
        ...
        {
            this.RunQueue();
            this._dataWriterEngine.OpenObject();
        }

        public void WriteValue(string propName, string value)
        {
            this.RunQueue();
            this._dataWriterEngine.WriteValue(propName, value);
        }
        /// <summary>
        ...
        {
            this.RunQueue();
            this._dataWriterEngine.StartElement(name, isObj);
        }
        
        public void CloseObject()
        {
            this.RunQueue();
            this._dataWriterEngine.CloseObject();
        }

        public void CloseArray()
        {
            this.RunQueue();
            this._dataWriterEngine.CloseArray();
        }
