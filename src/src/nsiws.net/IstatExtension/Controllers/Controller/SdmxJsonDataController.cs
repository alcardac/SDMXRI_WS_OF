namespace IstatExtension.Controllers.Controller
{
    ...
    /// </typeparam>
    public class SdmxJsonDataController<TWriter> : DataControllerBase,
                                                   ...
                                                   IController<Message, TWriter>
    {
        ...
        ///     The _log.
        /// </summary>
        private readonly ILog _log = LogManager.GetLogger(typeof(SdmxJsonDataController<TWriter>));
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SdmxJsonDataController{TWriter}"/> class.
        /// </summary>
        ...
        /// </exception>
        public SdmxJsonDataController(IResponseGenerator<TWriter, IDataQuery> responseGenerator, IDataRequestValidator validator, DataflowPrincipal principal)
            : base(principal)
        {
