...
namespace IstatExtension.Retriever
{
    ...
    using IstatExtension.Retriever.Builders;
    ...
    using IstatExtension.Retriever.Manager;
    ...
    /// </code>
    /// </example>
    public class JsonDataRetrieverCore : IDataRetrieverTabular, ISdmxDataRetrievalWithWriter, ISdmxDataRetrievalWithCrossWriter, IAdvancedSdmxDataRetrievalWithWriter
    {
        ...
        /// </exception>
        public JsonDataRetrieverCore(ConnectionStringSettings connectionStringSettings)
        {
        ...
        /// ConnectionStringSettings is null
        /// </exception>
        public JsonDataRetrieverCore(IHeader defaultHeader, ConnectionStringSettings connectionStringSettings)
        ...
        public JsonDataRetrieverCore(IHeader defaultHeader, ConnectionStringSettings connectionStringSettings, SdmxSchemaEnumType sdmxSchemaVersion)
        ...
        public void GetData(IDataQuery dataQuery, IDataWriterEngine dataWriter)
        {
            ...
            try
            {
                ...
                //SDMXJSON
                SdmxJsonSeriesDataQueryEngine.Instance._dsd = dataQuery.DataStructure;
                SdmxJsonSeriesDataQueryEngine.Instance._dfo = dataQuery.Dataflow;
                ...
                //// execute sql query SDMXJSON
                if (info.DimensionAtObservation != null && info.DimensionAtObservation.Equals("allDimensions"))
                {
                    this.ExecuteSql(info, TabularDataQueryEngine.Instance);
                }
                else
                {
                    this.ExecuteSql(info, SdmxJsonSeriesDataQueryEngine.Instance);
                }
        ...
        public void RetrieveData(IDataQuery query, ITabularWriter writer, bool showOriginal)
        {
            ...
            try
            {
                ...
                // execute sql query
                IDataQueryEngine dataQueryEngine = showOriginal
                                                       ? (IDataQueryEngine)TabularDataOriginalQueryEngine.Instance
        ...
        private MappingSetEntity RetrieveMappingSet(IDataflowObject dataFlow)
        {
            ...
            {
                mappingSet = 
                    MappingSetRetriever.GetMappingSet(
        ...
        //public MappingSetEntity ConvertMappingEntity(MappingSetEntity Map)
        //{
        //    MappingSetEntity JsonMap = new MappingSetEntity(Map.SysId);

        //    JsonMap.Dataflow = Map.Dataflow;
        //    JsonMap.DataSet = Map.DataSet;
        //    JsonMap.Description = Map.Description;
        //    JsonMap.Id = Map.Id;
        //    JsonMap.Mappings = Map.Mappings;
