        ...
        private void BuildMappings()
        {
            ...
            foreach (MappingEntity mapping in this._mappingSet.Mappings)
            {
                if (this.IsTimeDimensionMapping(mapping))
                {
                    ...
                    //this._timeTranscoder = TimeDimensionMapping.Create(mapping, this._mappingSet.DataSet.Connection.DBType);
                    this._timeTranscoder = TimeDimensionMapping.Create(mapping, null, MappingSet.DataSet.Connection.DBType);
