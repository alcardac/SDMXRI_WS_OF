...
namespace CSVZip.Engine
{
    ...
    using Org.Sdmxsource.Sdmx.SdmxObjects.Model.Objects;
    using System.Net;
    ...
    /// </summary>
    public class CsvZipDelayedDataWriterEngine : ICsvZipDataWriterEngine
    {
        /// <summary>
        /// The _actions
        /// </summary>
        ...
        /// </summary>
        private readonly ICsvZipDataWriterEngine _dataWriterEngine;


        private IMutableStructureSearchManager _structureSearchManager;

        //public  Estat.Nsi.DataRetriever.Model.DataRetrievalInfoSeries infos;
        ...
        public CsvZipDelayedDataWriterEngine(ICsvZipDataWriterEngine dataWriterEngine, Queue<Action> actions)
        {
            if (dataWriterEngine == null)
            {
                throw new ArgumentNullException("CsvZipdataWriterEngine");
            }
        ...
        /// <param name="valueRen">The value_ren.</param>
        public void WriteAttributeValue(string id, string valueRen)
        {
            this.RunQueue();
            this._dataWriterEngine.WriteAttributeValue(id, valueRen);
        }
        ...
        {
            this.RunQueue();
            this._dataWriterEngine.WriteGroupKeyValue(id, valueRen);
        }
        ...
        /// </param><param name="value_ren">The value_ren.
        /// </param>
        public void WriteSeriesKeyValue(string id, string value_ren)
        {
            this.RunQueue();
            this._dataWriterEngine.WriteSeriesKeyValue(id, value_ren);
        }
