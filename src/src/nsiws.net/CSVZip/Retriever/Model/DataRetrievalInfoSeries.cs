...
namespace CSVZip.Retriever.Model
{
    ...
    internal class DataRetrievalInfoSeries : DataRetrievalInfo
    {
        ...
        /// </summary>
        private readonly ICsvZipDataWriterEngine _seriesWriter;
        ...
        public DataRetrievalInfoSeries(MappingSetEntity mappingSet, IDataQuery query, ConnectionStringSettings connectionStringSettings, ICsvZipDataWriterEngine seriesWriter, SdmxSchemaEnumType sdmxSchemaVersion)
        ...
        public DataRetrievalInfoSeries(
            ...
            ICsvZipDataWriterEngine seriesWriter)
        ...
        /// </summary>
        public ICsvZipDataWriterEngine SeriesWriter
        {
            get
            {
