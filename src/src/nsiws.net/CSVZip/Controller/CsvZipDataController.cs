namespace CSVZip.Controller
{
    ...
    /// </typeparam>
    public class CsvZipDataController<TWriter> : DataControllerBase,
                                               ...
                                               IController<Message, TWriter>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CsvZipDataController{TWriter}"/> class.
        /// </summary>
        ...
        /// </exception>
        public CsvZipDataController(IResponseGenerator<TWriter, IDataQuery> responseGenerator, IDataRequestValidator validator, DataflowPrincipal principal)
            : base(principal)
        {
