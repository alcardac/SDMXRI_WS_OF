...
namespace Estat.Sri.Ws.Controllers.Controller
{
    ...
    /// </typeparam>
    public class SimpleDataController<TWriter> : DataControllerBase, 
                                                 ...
                                                 IController<Message, TWriter>
    {
        ...
        /// </exception>
        public SimpleDataController(IResponseGenerator<TWriter, IDataQuery> responseGenerator, IDataRequestValidator validator, DataflowPrincipal principal)
            : base(principal)
        {
