...
namespace DsplDataFormat.Retriever
{
    using System;
    ...
    using DsplDataFormat.Retriever.Engines;
    ...
    using DsplDataFormat.Retriever.Manager;    
    ...
    /// </code>
    /// </example>
    public class DsplDataRetrieverCore : IDsplDataRetrievalWithWriter
    {
        ...
        private static readonly ILog Logger = LogManager.GetLogger(typeof(DsplDataRetrieverCore));
        ...
        /// </exception>
        public DsplDataRetrieverCore(ConnectionStringSettings connectionStringSettings)
        {
        ...
        /// ConnectionStringSettings is null
        /// </exception>
        public DsplDataRetrieverCore(IHeader defaultHeader, ConnectionStringSettings connectionStringSettings)
