...
namespace DsplDataFormat.Engine.Manager
{
    using System;
    ...
    /// </summary>
    public interface IDsplDataRetrievalWithWriter
    {
        void GetData(IDataQuery dataQuery, IDsplDataWriterEngine dataWriter);
    }
}
