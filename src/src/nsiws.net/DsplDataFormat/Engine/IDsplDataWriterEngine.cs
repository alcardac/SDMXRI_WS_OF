...
namespace DsplDataFormat.Engine
{
    ...
    /// </summary>
    /// <example>
    ///     A sample in C# for <see cref="IDataWriterEngine" />
    ///     <code source="..\ReUsingExamples\DataWriting\ReUsingCompactWriter.cs" lang="cs" />
    /// </example>
    public interface IDsplDataWriterEngine : IWriterEngine
    {
        ...
        /// <param name="dsd">The data structure is used to know the dimenisonality of the data </param>
        /// <param name="header" remarks="Optional">Datset header containing, amongst others, the dataset action, reporting dates, 
        /// dimension at observation if null then the dimension at observation is assumed to be TIME_PERIOD and the dataset action is assumed to be INFORMATION
        /// </param>
        /// <param name="annotations" remarks="Optional">Any additional annotations that are attached to the dataset, can be null if no annotations exist </param>
        /// <exception cref="System.ArgumentException">
        /// if the dsd is null
        /// </exception>
        void StartDataset(string dsdName, IDataflowObject dataflow, IDataStructureObject dsd, IDatasetHeader header, params IAnnotation[] annotations);
        ...
        void StartGroup(string groupId, params IAnnotation[] annotations);
        ...
        void StartSeries(params IAnnotation[] annotations);
        ...
        /// The value_ren.
        /// </param>
        void WriteAttributeValue(string id, string valueRen);
        ...
        /// The value_ren.
        /// </param>
        void WriteGroupKeyValue(string id, string valueRen);
        ...
        void WriteObservation(string obsConceptValue, string obsValue, params IAnnotation[] annotations);
        ...
        ///     <ul>
        ///         <li>The obsTime string format is one of an allowed SDMX time format</li>
        ...
        /// </param>
        /// <param name="annotations">Any additional annotations that are attached to the observation, can be null if no annotations exist </param>
        void WriteObservation(string observationConceptId, string obsConceptValue, string obsValue, params IAnnotation[] annotations);
        ...
        /// the time format to format the obsTime in when converting to a string
        /// </param>
        /// <param name="annotations"> </param>
        void WriteObservation(DateTime obsTime, string obsValue, TimeFormat sdmxSwTimeFormat, params IAnnotation[] annotations);
        ...
        /// The value_ren.
        /// </param>
        void WriteSeriesKeyValue(string id, string value_ren);

        void SetDsdOrder(IDataStructureObject dsd);
