...
namespace DsplDataFormat.Engine
{
    ...
    /// </summary>
    public class DsplDelayedDataWriterEngine : IDsplDataWriterEngine, IDisposable
    {
        /// <summary>
        /// The _actions
        /// </summary>
        ...
        /// </summary>
        private readonly IDsplDataWriterEngine _dataWriterEngine;
        ...
        public DsplDelayedDataWriterEngine(IDsplDataWriterEngine dataWriterEngine, Queue<Action> actions)
        {
            if (dataWriterEngine == null)
            {
                throw new ArgumentNullException("DspldataWriterEngine");
            }
        ...
        {
            this.RunQueue();
            this._dataWriterEngine.SetDsdOrder(dsd);
        }
