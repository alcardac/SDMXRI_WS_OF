...
namespace DsplDataFormat.Controller.Builder
{
    ...
    ///     The <see cref="IDataWriterEngine" /> engine builder from <see cref="XmlWriter" /> or <see cref="Stream" />
    /// </summary>
    public class DsplDataWriterBuilder : IWriterBuilder<IDsplDataWriterEngine, DsplTextWriter>
    {
        #region Fields
        ...
        /// The sdmx Schema.
        /// </param>
        public DsplDataWriterBuilder(BaseDataFormat dataFormat, SdmxSchema sdmxSchema)
        {
            this._dataFormat = dataFormat;
            this._sdmxSchema = sdmxSchema;
        }
        public DsplDataWriterBuilder()
        {
        ...
        public IDsplDataWriterEngine Build(DsplDataFormat.Engine.DsplTextWriter writer, Queue<Action> actions)
        {
            return new DsplDelayedDataWriterEngine(new DsplDataFormat.Engine.DsplBaseDataWriter(writer), actions);
        }
