namespace DsplDataFormat.Controller
{
    ...
    /// </typeparam>
    public class DsplDataController<TWriter> : DataControllerBase,
                                               ...
                                               IController<Message, TWriter>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DsplDataController{TWriter}"/> class.
        /// </summary>
        ...
        /// </exception>
        public DsplDataController(IResponseGenerator<TWriter, IDataQuery> responseGenerator, IDataRequestValidator validator, DataflowPrincipal principal)
            : base(principal)
        {
