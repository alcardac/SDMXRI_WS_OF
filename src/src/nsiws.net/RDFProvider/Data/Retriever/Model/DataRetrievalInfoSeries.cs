...
namespace RDFProvider.Retriever.Model
{
    ...
    /// </summary>
    public class DataRetrievalInfoSeries : DataRetrievalInfo
    {
        ...
        /// </summary>
        private readonly IRDFDataWriterEngine _seriesWriter;
        ...
        public DataRetrievalInfoSeries(
            ...
            IRDFDataWriterEngine seriesWriter)
            : base(mappingSet, query, connectionStringSettings)
        {
            this._seriesWriter = seriesWriter;
            this._seriesObsComponents = new List<IComponentMapping>();
        ...
        /// </summary>
        public IRDFDataWriterEngine SeriesWriter
        {
            get
            {
